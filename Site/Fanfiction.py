    ...
    def __init__(self, url):
        ...
        try:
            ...
            self.chapters.append(
                soup.find("b", attrs={"class": "xcontrast_txt"}).text.strip()
            )
        ...
        # print("Chapters:")
        # print(self.chapters)
        self.summary = soup.find_all("div", attrs={"class": "xcontrast_txt"})[
            0
        ].text.strip()
        self.author = soup.find_all("a", attrs={"class": "xcontrast_txt"})[
            2
        ].text.strip()
        ...
        if (
            soup.find("button", attrs={"type": "BUTTON"}) is not None
            and soup.find("button", attrs={"type": "BUTTON"}).text.strip() == "< Prev"
        ):
            print(
